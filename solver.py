...
def taboo_cells(warehouse):
    '''  
    Identifies the taboo cells of a warehouse. A cell inside a warehouse is 
...
class SokobanPuzzle(search.Problem):
    ...
    If self.macro is set True, the 'actions' function returns 
    macro actions. If self.macro is set False, the 'actions' function
    returns elementary actions.
    '''
...
def solve_sokoban_elem(warehouse):
    '''    
    This function should solves elementary actions 
...
def solve_sokoban_macro(warehouse):
    ...
    a parameter. A sequence of macro actions is 
